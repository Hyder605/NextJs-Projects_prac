...
export default function Hero() {
    return (
        <Wrapper>
            <section>
                <div className=" flex flex-col-reverse md:flex-row justify-between bg-green-200 px-3 lg:px-32 md:pl-[150px] md:mt-16
                bg-gradient-to-r from-secondary to-primary/90">
                    <div className="pt-10 md:pt-[138px] space-y-3">
                        <h1 className="font-extrabold text-5xl">Hey I am Alex</h1>
