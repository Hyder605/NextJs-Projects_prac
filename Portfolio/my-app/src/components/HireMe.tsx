...
export default function HireMe() {
    return (
        <section>
            <div className=' h-64 md:h-64 py-8'>
                <div className='bg-gradient-to-t bg-emerald-300 h-full flex flex-col rounded-full md:mx-5 lg:mx-24 xl:mx-44 justify-center items-center'>
                    ...
                    <button className="bg-red-500 rounded-full border-2 border-red-300 w-48 h-14 font-semibold text-2xl mt-3 text-white">Hire Me</button>
                </div>
            </div >
