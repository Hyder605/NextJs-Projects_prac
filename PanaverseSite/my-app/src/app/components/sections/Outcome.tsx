            ...
            <Wrapper>
                <div className='flex gap-x-8 items-center flex-col-reverse md:flex-row'>
                    <div className='flex-1 md:relative'>
                        <Image className='z-0' src={h} alt="imageOutcome" />
                        <div className='md:w-[90%] md:h-52  md:absolute  md:top-20 md:bg-green-100 blur-2xl md:-z-10 md:rounded-full'></div>
                    </div>
                    <div className='flex-1'>
                        <h4 className='font-bold text-5xl'>The Outcome for Participants of the Program</h4>
                        ...
                        <div className='mt-6 grid grid-cols-2 gap-x-2 gap-y-4' >
                            {outcomesPoints.map((item, i) =>

                                <div className="flex items-center gap-x-2 md:relative" key={i}>
                                    ...
                                    <div className='w-32 h-32 rounded-full bg-green-100 md:absolute top-5 blur-3xl'></div>
                                </div>
                            )}
                        </div>
                    </div>
